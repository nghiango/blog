...
import { ChevronDownIcon, HomeIcon, ShieldCheckIcon, ArrowPathIcon, Squares2X2Icon, BookmarkSlashIcon, XMarkIcon } from "@heroicons/react/24/solid";
...
export default function Header() {
  return (
    <Popover className="fixed bg-white w-full z-10 top-0">
